...
from pymodbus.client.asyncio.thread import EventLoopThread
...
def reactor_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    from pymodbus.client.asyncio.twisted import ModbusTcpClientProtocol
...
def io_loop_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    from pymodbus.client.asyncio.tornado import AsyncModbusTCPClient as \
        Client
...
def async_io_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    """
    import asyncio
    from pymodbus.client.asyncio.asyncio import init_tcp_client
